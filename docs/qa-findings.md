...
**Status:** Three exploratory runs logged. EXPLORE-030 (qwik-fullstack) logged 7
...
The blockers (QF-001 install path, QF-007 corrupted test file) plus all majors
must be converted to user stories before VERIFY-040.
