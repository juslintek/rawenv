...
**Status:** Two exploratory runs logged. EXPLORE-030 (qwik-fullstack) logged 7
...
minor) and reproduced QF-001/QF-004/QF-005/QF-006 against a second project. The
blockers (QF-001 install path, QF-007 corrupted test file) plus all majors must
be converted to user stories before VERIFY-040.
